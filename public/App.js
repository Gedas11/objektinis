...
var newStudent = new Student('jonas', 'james@gmail.com', 'bit', 'js');
...
var User = /*#__PURE__*/function () {
  ...
  _createClass(User, [{
    ...
    value: function printInfo() {
      console.log("sveiki as esu ".concat(this.name, ". \n     mano el pastas yra : ").concat(this.email, ". Dirbu ").concat(this.department));
    }
  }]);
